...
<head>
    ...
    <title>Articles - iSéries-TV</title>
        ...
        <section class="hot-news">
            ...
            <div class="news-container">
                ...
                <article>
                    ...
                    <p>Ca fait déjà quelques années que la série est disponible sur la plateforme de streaming...</p>
            ...
            <div class="article-container">
                <div class="article">
                    ...
                    <div class="article-content">
                        ...
                        <a href="article1.php?user_id=<?php echo htmlspecialchars($user_id); ?>">Lire la suite</a>
                    </div>
                </div>
                <div class="article">
                    ...
                    <div class="article-content">
                        ...
                        <a href="article2.php?user_id=<?php echo htmlspecialchars($user_id); ?>">Lire la suite</a>
                    </div>
                </div>
                <div class="article">
                    ...
                    <div class="article-content">
                        ...
                        <a href="article5.php?user_id=<?php echo htmlspecialchars($user_id); ?>">Lire la suite</a>
                    </div>
                </div>
                <div class="article">
                    ...
                    <div class="article-content">
                        ...
                        <a href="article4.php?user_id=<?php echo htmlspecialchars($user_id); ?>">Lire la suite</a>
                    </div>
                </div>
                <div class="article">
...
La série se distingue par la richesse de ses personnages et la complexité de leurs relations. Chaque personnage apporte une dimension unique à l'intrigue, qu'il s'agisse des conflits familiaux, des histoires d'amour tumultueuses ou des défis professionnels. Les costumes colorés et les décors authentiques ajoutent une touche de réalisme et d'attrait visuel à la série, captivant les spectateurs à chaque épisode.
                        ...
                        <a href="article3.php?user_id=<?php echo htmlspecialchars($user_id); ?>">Lire la suite</a>
                    </div>
                </div>
                <div class="article">
                ...
                <div class="article">
                    <img src="20240208_102817.jpg" alt="Image de l'article 2">
                    <div class="article-content">
                        <h3>Gros plan sur la série musicale Empire</h3>
                        <p>Friends est une série télévisée américaine créée par David Crane et Marta Kauffman. Diffusée de 1994 à 2004, elle suit la vie de six amis vivant à New York : Rachel, Ross, Monica, Chandler, Joey et Phoebe. Interprétés respectivement par Jennifer Aniston, David Schwimmer, Courteney Cox, Matthew Perry, Matt LeBlanc et Lisa Kudrow, ces personnages évoluent à travers leurs relations amoureuses, professionnelles, et personnelles. Friends est acclamée pour son humour, ses situations comiques et la chimie entre ses acteurs. La série est devenue un phénomène culturel, influençant des générations de téléspectateurs et restant populaire même après des décennies.</p>
                        <a href="article8.php?user_id=<?php echo htmlspecialchars($user_id); ?>">Lire la suite</a>
                    </div>
                </div>
    ...
    <footer>
        <div class="footer-container">
            <div class="footer-menus">
                <ul>
                    <li><i class="fas fa-home"></i><a href="index.php?user_id=<?php echo htmlspecialchars($user_id); ?>">Accueil</a></li>
                    <li><i class="fas fa-newspaper"></i><a href="articlephp?user_id=<?php echo htmlspecialchars($user_id); ?>">Articles</a></li>
                    <li><i class="fas fa-poll"></i><a href="sondage2.php?user_id=<?php echo htmlspecialchars($user_id); ?>">Sondages</a></li>
                    <li><i class="fas fa-tv"></i><a href="streaming2.php?user_id=<?php echo htmlspecialchars($user_id); ?>">Streaming</a></li>
